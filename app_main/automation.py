...
def automate_usdot_private_inter(company_id, progress_id, data):
    try:
        ...
        auto.update_auto_progress_with_ss(progress_id=progress_id, step=89)
...
def automate_usdot_household(company_id, progress_id, data):
    try:
        ...
        # #step 54
        auto.element_is_presence("form_B0111P110011")
        auto.element_clicked_by_id("menu_next_text")

        auto.update_auto_progress_with_ss(progress_id=progress_id, step=54)

        # step 55
        auto.element_is_presence('form_hhgCertify')
        auto.automate_by_value(auto.element_filled_by_id,'Q11002_FIRST_NAME',data,'step_64','first_name')
        # auto.automate_by_value(auto.element_filled_by_id,'Q15007_MIDDLE_NAME',data,'step_64','middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q11003_LAST_NAME',data,'step_64','last_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q11005_ESIGN',data,'step_64','esignature_application_password')
        auto.automate_by_value(auto.element_filled_by_id,'Q11004_TITLE',data,'step_64','title')
        # auto.element_clicked_by_id('questionCode_B0161P160031S16003_Q16003_id_Y')
        auto.element_clicked_by_id('menu_next_text')
        ...
        # #step 56
        auto.element_is_presence('form_hhgProgram')
        auto.automate_by_value(auto.element_filled_by_id,'Q11008_PROGRAM_NAME',data,'step_65','arbitration_program_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q11009_ADDR1',data,'step_65','address_line_1')
        auto.automate_by_value(auto.element_filled_by_id,'Q11015_POSTAL_CODE',data,'step_65','postal_code')

        auto.automate_by_value(auto.element_filled_enter_by_id,'Q11016_TELEPHONE_ccode_id',data,'step_65','country')
        auto.automate_by_value(auto.element_filled_by_id,'Q11016_TELEPHONE_acode_id',data,'step_65','area_code')
        auto.automate_by_value(auto.element_filled_by_id,'Q11016_TELEPHONE_pcode_id',data,'step_65','phone_number')
        auto.element_clicked_by_id('menu_next_text')

        auto.update_auto_progress_with_ss(progress_id=progress_id, step=56)

        # step 57
        auto.element_is_presence('form_hhgEsign')
        auto.automate_by_value(auto.element_filled_by_id,'Q11018_ESIGN',data,'step_66','esignature_application_password')
        auto.automate_by_value(auto.element_filled_by_id,'Q11020_TITLE',data,'step_66','title')
        auto.element_clicked_by_id('menu_next_text')

        auto.update_auto_progress_with_ss(progress_id=progress_id, step=57)

        #step 58
        auto.element_is_presence('form_B0111P110071') 
        auto.element_clicked_by_id('menu_next_text')
        ...
        # #step 74
        auto.element_is_presence('form_B0161P160101')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0161P160101S16010_Q16010_id',data,'step_83','electronic_signature_application_password')
        auto.element_clicked_by_id("menu_next_text")
        ...
        auto.element_clicked_by_id('menu_next_text')
        auto.update_auto_progress_with_ss(progress_id=progress_id, step=85)

        # #step 86
        auto.element_is_presence('form_B0181P180011')
        auto.element_clicked_by_id('menu_next_text')

        auto.update_auto_progress_with_ss(progress_id=progress_id, step=86)

        # #step 87
        auto.element_is_presence('form_B0181P180021')
        auto.element_clicked_by_id('menu_next_text')

        auto.update_auto_progress_with_ss(progress_id=progress_id, step=87)

        # step 88
        auto.element_is_presence("form_paymentInfo")
        if data["step_88"]["card"] == "vi":
            auto.element_clicked_by_id("Q18007_CREDIT_CARD_TYPEVisa")
        elif data["step_88"]["card"] == "mc":
            auto.element_clicked_by_id("Q18007_CREDIT_CARD_TYPEMasterCard")
        elif data["step_88"]["card"] == "ax":
        ...
        auto.automate_by_value(
            auto.element_filled_by_id, "Q18012_CC_FNAME", data, "step_88", "first_name"
        )
        # auto.automate_by_value(auto.element_filled_by_id,'Q18017_CC_MNAME',data,'step_88','middle_name')
        auto.automate_by_value(
            auto.element_filled_by_id, "Q18016_CC_LNAME", data, "step_88", "last_name"
        )
        # auto.automate_by_value(auto.element_filled_by_id,'Q18____CC_SUFFIX',data,'step_88','suffix')
        auto.automate_by_value(
            auto.element_filled_by_id,
            "Q18013_CC_ESIGN",
            data,
        ...
        auto.update_auto_progress_with_ss(progress_id=progress_id, step=88)
