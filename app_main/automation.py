...
class Automation:
    ...
    def element_is_presence(self, id):
        try:
            WebDriverWait(self.driver, self.timeout).until(EC.presence_of_element_located((By.ID, id)))
    ...
    def update_auto_progress_with_ss(self,progress_id=None,step=0):
        try:
            if self.progress_id:
                ...
                if self.save_ss_to:
                    self.driver.get_screenshot_as_file(f'{self.save_ss_to}/step_{step}.png')
...
def automate_usdot_free(company_id, progress_id, data):
    try:
        ...
        auto.automate_by_value(auto.element_filled_by_id,'newUserPasswd',data,'step_9','create_password')
        auto.automate_by_value(auto.element_filled_by_id,'newUserPasswdAgain',data,'step_9','confirm_password')
        auto.automate_by_value(auto.element_filled_enter_by_id,'secQuestion1SelectList',data,'step_9','security_question_1')
        auto.automate_by_value(auto.element_filled_by_id,'securityAnswer1',data,'step_9','security_answer_1')
        auto.automate_by_value(auto.element_filled_enter_by_id,'secQuestion2SelectList',data,'step_9','security_question_2')
        auto.automate_by_value(auto.element_filled_by_id,'securityAnswer2',data,'step_9','security_answer_2')
        auto.automate_by_value(auto.element_filled_enter_by_id,'secQuestion3SelectList',data,'step_9','security_question_3')
        auto.automate_by_value(auto.element_filled_by_id,'securityAnswer3',data,'step_9','security_answer_3')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03001_APP_CONTACT_TYPE',data,'step_11','application_contact_type')
        auto.automate_by_value(auto.element_filled_by_id,'Q03002_APP_CONT_FIRST_NAME',data,'step_11','application_contact_first_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q03022_APP_CONT_MIDDLE_NAME',data,'step_11','application_contact_middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q03003_APP_CONT_LAST_NAME',data,'step_11','application_contact_last_name')
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03023_APP_CONT_SUFFIX',data,'step_11','application_contact_suffix')

        auto.automate_by_value(auto.element_filled_by_id,'Q03021_APP_CONT_TITLE',data,'step_11','application_contact_title')
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03011_APP_CONT_COUNTRY',data,'step_11','application_contact_country')
        auto.automate_by_value(auto.element_filled_by_id,'Q03004_APP_CONT_ADDR1',data,'step_11','application_contact_street_address_line_1')
        auto.automate_by_value(auto.element_filled_by_id,'Q03005_APP_CONT_ADDR2',data,'step_11','application_contact_street_address_line_2')

        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03010_APP_CONT_POSTAL_CODE',data,'step_11','application_contact_postal_code')
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03012_APP_CONT_TEL_NUM_ccode_id',data,'step_11','application_contact_telephone_number','country_code')
        auto.automate_by_value(auto.element_filled_by_id,'Q03012_APP_CONT_TEL_NUM_acode_id',data,'step_11','application_contact_telephone_number','area_code')
        auto.automate_by_value(auto.element_filled_by_id,'Q03012_APP_CONT_TEL_NUM_pcode_id',data,'step_11','application_contact_telephone_number','phone_number')
        auto.automate_by_value(auto.element_filled_by_id,'Q03012_APP_CONT_TEL_NUM_ecode_id',data,'step_11','application_contact_telephone_number','extra_phone_number')

        auto.automate_by_value(auto.element_filled_enter_by_id,'Q03018_APP_CONT_PREF_METHOD',data,'step_11','application_contact_preferred_contact_method')
        auto.automate_by_value(auto.element_filled_by_id,'Q03015_APP_CONT_EMAIL',data,'step_11','application_contact_email_address')
        auto.automate_by_value(auto.element_filled_by_id,'Q03016_APP_CONT_EMAIL_CONFIRM',data,'step_11','application_contact_confirm_email_address')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_enter_by_id,'questionCode_B0041P040061S04001_Q04001_LEGAL_BUS_NAME_id',data,'step_14','legal_business_name')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_enter_by_id,'questionCode_B0041P040101S04005_Q04021_BUS_TEL_NUM_ccode_id',data,'step_18','country')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0041P040101S04005_Q04021_BUS_TEL_NUM_acode_id',data,'step_18','area_code')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0041P040101S04005_Q04021_BUS_TEL_NUM_pcode_id',data,'step_18','phone_number')
        auto.element_clicked_by_id('menu_next_text')
        ...
        if einExist:
            auto.element_clicked_by_id('questionCode_B0041P040111S04006_Q04024_EIN_SSN_id_1')
            auto.element_filled_by_id('questionCode_B0041P040111S04006_Q04040_id', einValue)
        elif ssnExist:
            auto.element_clicked_by_id('questionCode_B0041P040111S04006_Q04024_EIN_SSN_id_2')
            auto.element_filled_by_id('questionCode_B0041P040111S04006_Q04040_id',ssnValue)
        auto.element_clicked_by_id('menu_next_text')
        ...
        if data['step_20']['checked']:
            auto.element_clicked_by_id('questionCode_B0041P040201S04024_Q04054_GOVT_UNIT_id_Y')
        else:
            auto.element_clicked_by_id('questionCode_B0041P040201S04024_Q04054_GOVT_UNIT_id_N')
        ...
        checkboxs = auto.driver.find_element(By.XPATH, '//*[@id="form_bdProprietor"]/table/tbody/tr/td/table/tbody/tr[2]/td/table').find_elements(By.TAG_NAME,'tr')
        for i in checkboxs:
            if data['step_21']['checked'] in i.find_element(By.TAG_NAME,'label').text:
                i.find_element(By.TAG_NAME,'input').click()
                
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q04032_FORM_OF_BUS_STATE',data,'step_21','choose_one')
        auto.element_clicked_by_id('menu_next_text')
        ...
        checkboxs = auto.driver.find_element(By.XPATH, '//*[@id="form_bdOwnership"]/table/tbody/tr/td/table/tbody/tr[2]/td/table').find_elements(By.TAG_NAME,'tr')
        for i in checkboxs:
        ...
        auto.automate_by_value(auto.element_filled_by_id,'proprietorFirstName_1_id',data,'step_23','first_name')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorMiddleName_1_id',data,'step_23','middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorLastName_1_id',data,'step_23','last_name')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorTitle_1_id',data,'step_23','title')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorEmail_1_id',data,'step_23','email')

        auto.automate_by_value(auto.element_filled_enter_by_id,'proprietorTelephone_1_ccode_id',data,'step_23','country')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorTelephone_1_acode_id',data,'step_23','area_code')
        auto.automate_by_value(auto.element_filled_by_id,'proprietorTelephone_1_pcode_id',data,'step_23','phone_number')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q04041_COUNTRY',data,'step_24','country')
        auto.automate_by_value(auto.element_filled_by_id,'Q04048_POSTAL_CODE',data,'step_24','postal_code')
        auto.automate_by_value(auto.element_filled_by_id,'Q04042_ADDRESS1',data,'step_24','street_address_or_route_number_line_1')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0061P060121S06061_Q06117_NON_CMV_PROP_ONLY_id',data,'step_42','non_cmv_property')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0061P060071S06007_Q06046_id',data,'step_44','canada')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0061P060071S06007_Q06047_id',data,'step_44','mexico')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0061P060081S06008_Q06048_id',data,'step_45','questionCode_B0061P060081S06008_Q06048_id')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0061P060091S06009_Q06049_id',data,'step_46','questionCode_B0061P060091S06009_Q06049_id')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070021S07002_Q07001_id',data,'step_49','questionCode_B0071P070021S07002_Q07001_id')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070021S07002_Q07002_id',data,'step_49','questionCode_B0071P070021S07002_Q07002_id')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070051S07003_Q07003_id',data,'step_50','questionCode_B0071P070051S07003_Q07003_id')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070051S07003_Q07004_id',data,'step_50','questionCode_B0071P070051S07003_Q07004_id')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070061S07004_Q07005_id',data,'step_51','questionCode_B0071P070061S07004_Q07005_id')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070031S07005_Q07006_id',data,'step_44','canada')
        auto.automate_by_value(auto.element_filled_by_id,'questionCode_B0071P070031S07005_Q07007_id',data,'step_44','mexico')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'Q15002_FNAME',data,'step_61','first_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q15007_MIDDLE_NAME',data,'step_61','middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q15003_LNAME',data,'step_61','last_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q15005_ESIGN',data,'step_61','esignature_application_password')
        auto.automate_by_value(auto.element_filled_by_id,'Q15004_TITLE',data,'step_61','title')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'Q17002_FNAME',data,'step_61','first_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q17007_MIDDLE_NAME',data,'step_61','middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q17003_LNAME',data,'step_61','last_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q17005_ESIGN',data,'step_61','esignature_application_password')
        auto.automate_by_value(auto.element_filled_by_id,'Q17004_TITLE',data,'step_61','title')
        auto.element_clicked_by_id('menu_next_text')
        ...
        auto.automate_by_value(auto.element_filled_by_id,'Q23043_RESP_MNAME',data,'step_80','middle_name')
        ...
        paymentMsg = auto.element_value_by_id("questionDesc_Q18028_NEW_REG_PAYMENT_OK_MSG")
...
def automate_usdot_paid(company_id, progress_id, data):
    try:
        auto = Automation()
        auto.progress_id = progress_id
        auto.company_id = company_id
        ...
        auto.automate_by_value(auto.element_filled_by_id,'Q18008_CREDIT_CARD_NUM',data,'step_83','credit_card_number')
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q18009_CREDIT_CARD_EXP_MM',data,'step_83','choose_exp_month')
        auto.automate_by_value(auto.element_filled_enter_by_id,'Q18010_CREDIT_CARD_EXP_YY',data,'step_83','choose_exp_year')
        auto.automate_by_value(auto.element_filled_by_id,'Q18011_CC_SECURITY_CODE',data,'step_83','security_code')
        auto.automate_by_value(auto.element_filled_by_id,'Q18012_CC_FNAME',data,'step_83','first_name')
        # auto.automate_by_value(auto.element_filled_by_id,'Q18017_CC_MNAME',data,'step_83','middle_name')
        auto.automate_by_value(auto.element_filled_by_id,'Q18016_CC_LNAME',data,'step_83','last_name')
        # auto.automate_by_value(auto.element_filled_by_id,'Q18____CC_SUFFIX',data,'step_83','suffix')
        auto.automate_by_value(auto.element_filled_by_id,'Q18013_CC_ESIGN',data,'step_83','electronic_signature_application_password')
        # auto.element_clicked_by_id('menu_next_text')
